...
public class WotrRiftLayoutLayers {
    ...
    public static final Supplier<MapCodec<BoxedLayer.Factory>> BOXED_LAYER = LAYOUT_LAYERS.register("boxed_layer",
            () -> BoxedLayer.Factory.CODEC);
    public static final Supplier<MapCodec<ChaosLayer.Factory>> CHAOS_LAYER = LAYOUT_LAYERS.register("chaos_layer",
            () -> ChaosLayer.Factory.CODEC);
    public static final Supplier<MapCodec<PredefinedRoomLayer.Factory>> PREDEFINED_LAYER = LAYOUT_LAYERS
            .register("predefined_room_layer", () -> PredefinedRoomLayer.Factory.CODEC);
    public static final Supplier<MapCodec<RingLayer.Factory>> RING_LAYER = LAYOUT_LAYERS.register("ring_layer",
            () -> RingLayer.Factory.CODEC);
