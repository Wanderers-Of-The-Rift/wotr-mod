...
import com.wanderersoftherift.wotr.commands.ProgressionTrackCommands;
...
public final class WotrCommands {
    ...
    public static void registerCommands(RegisterCommandsEvent event) {
        ...
        new ProgressionTrackCommands().registerCommand(event.getDispatcher(), event.getBuildContext());
