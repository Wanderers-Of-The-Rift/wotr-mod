...
public class WotrDataComponentType {
    ...
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Holder<AbstractGearAbility>>> GEAR_BASIC = register(
            "gear_basic", AbstractGearAbility.CODEC, AbstractGearAbility.STREAM_CODEC);
    public static final DeferredHolder<DataComponentType<?>, DataComponentType<Holder<AbstractGearAbility>>> GEAR_SECONDARY = register(
            "gear_secondary", AbstractGearAbility.CODEC, AbstractGearAbility.STREAM_CODEC);
