...
public class WotrGoalTypes {
    ...
    public static final Supplier<MapCodec<? extends Goal>> GIVE_ITEM = GOAL_TYPES.register("give_item",
            () -> GiveItemGoal.CODEC);

    public static final Supplier<MapCodec<? extends Goal>> KILL_MOB = GOAL_TYPES.register("kill_mob",
            () -> KillMobGoal.CODEC);
}
