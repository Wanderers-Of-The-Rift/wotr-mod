...
public class WotrRegistries {
    ...
    public static final class Keys {
        ...
        public static final ResourceKey<Registry<AbstractAbility>> GEAR_ABILITIES_KEY = ResourceKey
                .createRegistryKey(WanderersOfTheRift.id("gear_abilities_key"));
    ...
    public static void registerDatapackRegistries(DataPackRegistryEvent.NewRegistry event) {
        ...
        event.dataPackRegistry(Keys.GEAR_ABILITIES_KEY, AbstractAbility.DIRECT_CODEC, AbstractAbility.DIRECT_CODEC);
