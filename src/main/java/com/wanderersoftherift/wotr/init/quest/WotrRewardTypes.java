...
import com.wanderersoftherift.wotr.core.quest.reward.provider.ProgressionTrackRewardProvider;
...
public final class WotrRewardTypes {
    ...
    public static final Supplier<MapCodec<? extends RewardProvider>> PROGRESSION_TRACK_REWARD_PROVIDER = REWARD_PROVIDER_TYPES
    ...
    public static final Supplier<DualCodec<? extends Reward>> PROGRESSION_TRACK_REWARD = REWARD_TYPES
            .register("progression_track", () -> ProgressionTrackPointReward.TYPE);
