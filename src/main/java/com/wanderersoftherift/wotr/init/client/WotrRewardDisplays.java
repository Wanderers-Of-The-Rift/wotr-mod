...
import com.wanderersoftherift.wotr.gui.widget.reward.ProgressionTrackRewardWidget;
...
public class WotrRewardDisplays {
    ...
    private static void registerWidgets(RegisterRewardDisplaysEvent event) {
        ...
        event.register(ProgressionTrackPointReward.class, ProgressionTrackRewardWidget::new);
    }
}
