...
public class WotrTags {
    ...
    public static class Items {
        ...
        public static final TagKey<Item> SOCKETABLE_MAIN_HAND_SLOT_WEAPON = createTag("socketable_main_hand_slot_weapon");
        public static final TagKey<Item> SOCKETABLE_MAIN_HAND_SLOT_TOOL = createTag("socketable_main_hand_slot_tool");
        public static final TagKey<Item> SOCKETABLE_MAIN_HAND_SLOT_HYBRID = createTag("socketable_main_hand_slot_hybrid");
