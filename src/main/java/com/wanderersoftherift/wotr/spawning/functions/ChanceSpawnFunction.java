...
public record ChanceSpawnFunction(float chance, List<SpawnFunction> functions) implements SpawnFunction {
    ...
    public static final MapCodec<ChanceSpawnFunction> MAP_CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(
                    ...
                    SpawnFunction.CODEC.listOf().fieldOf("functions").forGetter(ChanceSpawnFunction::functions)
