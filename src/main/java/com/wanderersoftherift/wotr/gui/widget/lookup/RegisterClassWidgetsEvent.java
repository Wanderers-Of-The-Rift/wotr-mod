...
public class RegisterClassWidgetsEvent extends Event implements IModBusEvent {

    private final Map<Class<?>, Function<?, AbstractWidget>> registeredMappings;

    public RegisterClassWidgetsEvent(Map<Class<?>, Function<?, AbstractWidget>> registeredMappings) {
