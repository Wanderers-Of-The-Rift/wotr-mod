...
public class Utils3D {
     ...
     */
    public static Vector3f projectPoint(Vector3f worldPos, VirtualCamera camera, Vector2i mapPosition, Vector2i mapSize) {
    ...
    public static Vector3f projectPoint(float x, float y, float z, VirtualCamera camera, Vector2i mapPosition, Vector2i mapSize) {
        int mapWidth = mapSize.x; // this is the width and height of the window we want to draw
        int mapHeight = mapSize.y;
