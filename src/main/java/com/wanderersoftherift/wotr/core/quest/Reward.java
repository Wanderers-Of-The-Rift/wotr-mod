...
public interface Reward {
    Codec<Reward> DIRECT_CODEC = WotrRegistries.REWARD_TYPES.byNameCodec().dispatch(Reward::getType, DualCodec::codec);

    StreamCodec<RegistryFriendlyByteBuf, Reward> STREAM_CODEC = ByteBufCodecs.registry(WotrRegistries.Keys.REWARD_TYPES)
            .dispatch(Reward::getType, DualCodec::streamCodec);

    /**
     * @return The type of this reward
     */
    DualCodec<? extends Reward> getType();
