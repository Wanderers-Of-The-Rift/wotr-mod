    ...
    public static void bootstrapRuneGems(BootstrapContext<RunegemData> context) {
        ...
        registerRunegem(context, getRunegemResourceKey("magic_framed"),
                new RunegemData(getTranslatableName("magic_framed"), RunegemShape.SQUARE,
                        ...
                        RunegemTier.FRAMED));
        registerRunegem(context, getRunegemResourceKey("projectile_raw"), new RunegemData(getTranslatableName("projectile_raw"),
                RunegemShape.PENTAGON, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                        new TieredModifier(1, getModifier(lookup, "projectile_speed")),
                        new TieredModifier(1, getModifier(lookup, "projectile_spread"))
                ...
                , RunegemTier.RAW));
        registerRunegem(context, getRunegemResourceKey("projectile_cut"), new RunegemData(getTranslatableName("projectile_cut"),
                RunegemShape.PENTAGON, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                ...
                , RunegemTier.CUT));
        registerRunegem(context, getRunegemResourceKey("projectile_shaped"), new RunegemData(getTranslatableName("projectile_shaped"),
                RunegemShape.PENTAGON, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                        new TieredModifier(1, getModifier(lookup, "projectile_pierce")),
                        new TieredModifier(1, getModifier(lookup, "projectile_count")),
                ...
                , RunegemTier.SHAPED));
        registerRunegem(context, getRunegemResourceKey("projectile_polished"), new RunegemData(getTranslatableName("projectile_polished"),
                RunegemShape.PENTAGON, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                        new TieredModifier(1, getModifier(lookup, "projectile_pierce")),
                        new TieredModifier(1, getModifier(lookup, "projectile_count")),
                ...
                , RunegemTier.POLISHED));
        registerRunegem(context, getRunegemResourceKey("projectile_framed"), new RunegemData(getTranslatableName("projectile_framed"),
                RunegemShape.PENTAGON, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                        new TieredModifier(2, getModifier(lookup, "projectile_pierce")),
                        new TieredModifier(2, getModifier(lookup, "projectile_count")),
                ...
                , RunegemTier.FRAMED));
        registerRunegem(context, getRunegemResourceKey("skeleton_raw"), new RunegemData(getTranslatableName("skeleton_raw"),
                ...
                , RunegemTier.RAW));
        registerRunegem(context, getRunegemResourceKey("skeleton_cut"), new RunegemData(getTranslatableName("skeleton_cut"),
                RunegemShape.DIAMOND, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                        new TieredModifier(1, getModifier(lookup, "projectile_pierce")),
                        new TieredModifier(1, getModifier(lookup, "projectile_count")),
                ...
                , RunegemTier.CUT));
        registerRunegem(context, getRunegemResourceKey("skeleton_shaped"), new RunegemData(getTranslatableName("skeleton_shaped"),
                RunegemShape.DIAMOND, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                        new TieredModifier(1, getModifier(lookup, "projectile_pierce")),
                        new TieredModifier(1, getModifier(lookup, "projectile_count")),
                ...
                , RunegemTier.SHAPED));
        registerRunegem(context, getRunegemResourceKey("skeleton_polished"), new RunegemData(getTranslatableName("skeleton_polished"),
                RunegemShape.DIAMOND, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                        new TieredModifier(1, getModifier(lookup, "projectile_pierce")),
                        new TieredModifier(1, getModifier(lookup, "projectile_count")),
                ...
                , RunegemTier.POLISHED));
        registerRunegem(context, getRunegemResourceKey("skeleton_framed"), new RunegemData(getTranslatableName("skeleton_framed"),
                RunegemShape.DIAMOND, List.of(new RunegemData.ModifierGroup(
                        socketablesTag, List.of(
                        new TieredModifier(2, getModifier(lookup, "projectile_pierce")),
                        new TieredModifier(2, getModifier(lookup, "projectile_count")),
