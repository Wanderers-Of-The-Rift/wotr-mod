...
public class WotrRecipeProvider extends RecipeProvider {
    ...
    protected void buildRecipes() {
        ...
        KeyForgeRecipe
                .create(WotrDataComponentType.RiftConfigWotrDataComponentType.RIFT_THEME.get(),
        ...
        KeyForgeRecipe
                .create(WotrDataComponentType.RiftConfigWotrDataComponentType.RIFT_OBJECTIVE.get(),
