    ...
    private void generateEssenceItemLootTable(BiConsumer<ResourceKey<LootTable>, LootTable.Builder> consumer) {
        consumer.accept(getResourceKey("rift/essences"), LootTable.lootTable()
                .withPool(
                        LootPool.lootPool()
                                .setRolls(ConstantValue.exactly(1.0F))
                                .add(LootItem.lootTableItem(WotrItems.EARTH_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.WATER_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.DEATH_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.LIFE_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.NETHER_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.LIFE_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.HONEY_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.MUSHROOM_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.FABRIC_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.DARK_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.FIRE_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.AIR_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.ENERGY_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.ANIMAL_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.CRYSTAL_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.METAL_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.FOOD_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.SLIME_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.MIND_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.MECHA_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.END_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.FLOW_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.FORM_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.ORDER_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                                .add(LootItem.lootTableItem(WotrItems.CHAOS_ESSENCE)
                                        .setWeight(20)
                                        .apply((SetItemCountFunction.setCount(UniformGenerator.between(1.0F, 2.0F)))))
                ));
    }
