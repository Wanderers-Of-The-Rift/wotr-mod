    ...
    public Vec3 worldPosition(Entity entity) {
        switch (mode) {
            ...
            case LOCAL -> {
                ...
                return coordinates.getPosition(new CommandSourceStack(CommandSource.NULL, entity.position(),
                        new Vec2(entity.getXRot(), entity.getYRot()), (ServerLevel) entity.level(), 0, "",
                        Component.empty(), entity.level().getServer(), entity));
            }
        }
        return position;
    }
