...
public class ExportCommands extends BaseCommand {
    public ExportCommands() {
        super("export", Commands.LEVEL_OWNERS);
    }

    @Override
    protected void buildCommand(LiteralArgumentBuilder<CommandSourceStack> builder, CommandBuildContext context) {
        builder.then(Commands.literal("essencelessItems").executes(this::dumpUnspecified))
                .then(Commands.literal("essenceValues").executes(this::dumpSpecified));
    }
