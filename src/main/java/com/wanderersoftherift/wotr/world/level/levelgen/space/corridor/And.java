...
public record And(List<CorridorValidator> base) implements CorridorValidator {

    public static final MapCodec<And> CODEC = CorridorValidator.CODEC.listOf()
            .fieldOf("values")
            .xmap(And::new, And::base);

    public And(CorridorValidator... values) {
