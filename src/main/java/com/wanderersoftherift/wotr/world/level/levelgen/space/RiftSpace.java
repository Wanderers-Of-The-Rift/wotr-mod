...
public interface RiftSpace {
    ...
    public static void placePerimeterInChunk(ChunkAccess chunk, RiftSpace space, int level, BlockState perimeterBlock) {
    ...
    public static void placePerimeterInRiftChunk(RiftProcessedChunk chunk, RiftSpace space, BlockState perimeterBlock) {
        ...
        if(space==null || space instanceof VoidRiftSpace){
            ...
            var corridors = space.corridors().stream().filter((corridor)->
