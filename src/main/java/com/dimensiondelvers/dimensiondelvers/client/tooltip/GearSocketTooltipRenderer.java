...
public class GearSocketTooltipRenderer implements ClientTooltipComponent {
    public static final Map<RunegemShape, ResourceLocation> SHAPE_RESOURCE_LOCATION_MAP =
            Map.of(
                    RunegemShape.CIRCLE, DimensionDelvers.id("textures/tooltip/runegem/circle.png"),
                    RunegemShape.DIAMOND, DimensionDelvers.id("textures/tooltip/runegem/diamond.png"),
                    RunegemShape.HEART, DimensionDelvers.id("textures/tooltip/runegem/heart.png"),
                    RunegemShape.PENTAGON, DimensionDelvers.id("textures/tooltip/runegem/pentagon.png"),
                    RunegemShape.SQUARE, DimensionDelvers.id("textures/tooltip/runegem/square.png"),
                    RunegemShape.TRIANGLE, DimensionDelvers.id("textures/tooltip/runegem/triangle.png")
            );
    ...
    public static Component getSocketDesc() {
        return Component.translatable("tooltip.dimensiondelvers.socket");
    }
