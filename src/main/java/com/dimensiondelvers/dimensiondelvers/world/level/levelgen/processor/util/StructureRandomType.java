...
public enum StructureRandomType {
    ...
    public static final Codec<StructureRandomType> RANDOM_TYPE_CODEC = Codec.STRING.flatComapMap(s -> StructureRandomType.byName(s, null), d -> DataResult.success(d.name()));
